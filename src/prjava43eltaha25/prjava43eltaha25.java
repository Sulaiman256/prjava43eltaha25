...
public class prjava43eltaha25 extends Frame 
   ...
   public prjava43eltaha25 () { 
      ...
      setTitle("nova finestra prjava43eltaha25");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new prjava43eltaha25();  // Let the construct do the job 
   } 
